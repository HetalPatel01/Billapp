...
//            "[C]<img>" + PrinterTextParserImg.bitmapToHexadecimalString(printer, this.getApplicationContext().getResources().getDrawableForDensity(R.drawable.ic_launcher_foreground, DisplayMetrics.DENSITY_MEDIUM)) + "</img>\n" +
                "[L]\n" +
